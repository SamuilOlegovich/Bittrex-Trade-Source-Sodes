...
namespace Binance.API.Csharp.Client.Domain.Interfaces
{
    public interface IApiClient
    {
        ...
        string ConnectToWebSocket<T>(string parameters, MessageHandler<T> messageDelegate, Action<string> openHandler, bool useCustomParser = false);
        ...
        bool CloseWebSocket(string WebSocketID);

        bool RestartWebSocket(string WebSocketID);
    }
}